    ...
    menu: [
        {
            ...
            customization: ["Extra Cheese", "Coke", "Fries", "Onions", "Bacon"],
        },
        {
        ...
        },
        {
            ...
            customization: ["Jalapeños", "Iced Tea", "Fries", "Salad"],
        },
        {
            ...
            protein: 29,
            category_name: "Burgers",
            customization: ["Onions", "Fries", "Coke", "Bacon", "Avocado"],
        },
        {
            ...
            protein: 28,
            category_name: "Wraps",
            customization: ["Extra Cheese", "Coke", "Potato Wedges", "Tomatoes"],
        },
        {
            ...
            customization: ["Mushrooms", "Olives", "Mozzarella Sticks", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 20,
            category_name: "Wraps",
            customization: ["Jalapeños", "Tomatoes", "Salad", "Fries", "Iced Tea"],
        },
        {
            ...
            protein: 24,
            category_name: "Bowls",
            customization: ["Avocado", "Sweet Corn", "Salad", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 21,
            category_name: "Pizzas",
            customization: ["Extra Cheese", "Olives", "Coke", "Garlic Bread"],
        },
        {
            ...
            protein: 38,
            category_name: "Bowls",
            customization: ["Avocado", "Salad", "Sweet Corn", "Iced Tea"],
        },
        {
            name: "Paneer Burrito",
            ...
            protein: 22,
            category_name: "Burritos",
            customization: ["Jalapeños", "Fries", "Garlic Bread", "Coke"],
        },
        {
            ...
            protein: 31,
            category_name: "Sandwiches",
            customization: ["Bacon", "Tomatoes", "Mozzarella Sticks", "Iced Tea"],
        },
    ],
};
